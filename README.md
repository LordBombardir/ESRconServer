...
RconServer is a powerful plugin that introduces RCON (Remote Console) support to the [endstone](https://github.com/EndstoneMC/endstone). This allows for enhanced remote management of your server, enabling you to execute commands from a distance.
